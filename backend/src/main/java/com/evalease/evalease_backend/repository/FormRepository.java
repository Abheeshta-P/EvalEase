...
public interface FormRepository extends JpaRepository<Form, Long> {
    ...
    @Query("SELECT new com.evalease.evalease_backend.dto.RecentFormDTO(f.id, f.title, f.createdAt, COUNT(r.id)) " +
       "FROM Form f LEFT JOIN Response r ON r.submittedForm.form.id = f.id " +
